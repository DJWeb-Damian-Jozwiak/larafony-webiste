...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>{{ $title ?? 'Bridge Packages - Larafony Framework' }}</title>
    <meta name="description" content="{{ $description ?? 'Official bridge packages for Larafony Framework' }}">
    <meta name="keywords" content="Larafony, PHP 8.5, Bridges, Guzzle, Monolog, Symfony Mailer, Flysystem, Carbon, Twig, Smarty">
    <meta name="author" content="Larafony">
    <link rel="canonical" href="https://larafony.com{{ $_SERVER['REQUEST_URI'] ?? '/bridges' }}">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://larafony.com/bridges">
    <meta property="og:title" content="{{ $title ?? 'Bridge Packages - Larafony Framework' }}">
    <meta property="og:description" content="{{ $description ?? 'Official bridge packages for Larafony Framework' }}">
    <meta property="og:image" content="/logo.png">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://larafony.com/bridges">
    <meta property="twitter:title" content="{{ $title ?? 'Bridge Packages - Larafony Framework' }}">
    <meta property="twitter:description" content="{{ $description ?? 'Official bridge packages for Larafony Framework' }}">
        ...
        <div class="container-fluid">
            <div class="d-flex align-items-center justify-content-between">
                <a href="/" class="d-flex align-items-center text-decoration-none">
                    ...
                    <span class="text-muted ms-2">/ Bridges</span>
                </a>
                <div class="d-flex align-items-center gap-2">
                    ...
                    <a href="/docs" class="btn btn-sm btn-outline-light">
                        <i class="bi bi-book"></i><span class="d-none d-lg-inline"> Docs</span>
                    </a>
    ...
    <aside class="docs-sidebar">
        <nav>
            <div class="nav-section">
                <div class="nav-section-title">Bridge Packages</div>
            ...
            <div class="nav-section">
                <div class="nav-section-title">HTTP & API</div>
                <a href="/bridges/guzzle" class="nav-link">
                    <i class="bi bi-cloud-arrow-down me-2"></i>Guzzle HTTP
                </a>
            </div>

            <div class="nav-section">
                <div class="nav-section-title">Logging</div>
            ...
            <div class="nav-section">
                ...
                <a href="/bridges/symfony-mailer" class="nav-link">
                    <i class="bi bi-envelope-paper me-2"></i>Symfony Mailer
                </a>
            </div>
            ...
            <div class="nav-section">
                ...
                <a href="/bridges/flysystem" class="nav-link">
                    <i class="bi bi-folder2-open me-2"></i>Flysystem
                </a>
            </div>
            ...
            <div class="nav-section">
                ...
                <a href="/bridges/carbon" class="nav-link">
                    <i class="bi bi-calendar-date me-2"></i>Carbon Clock
                </a>
            </div>
            ...
            <div class="nav-section">
                ...
                <a href="/bridges/twig" class="nav-link">
                    <i class="bi bi-file-earmark-code me-2"></i>Twig
                </a>
                <a href="/bridges/smarty" class="nav-link">
                    <i class="bi bi-braces me-2"></i>Smarty
                </a>
            </div>

            <div class="nav-section">
                <div class="nav-section-title">Debugging</div>
